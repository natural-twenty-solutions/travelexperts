...
<head>
  ...
  <title>Travel Experts Dashboard</title>
  <!-- Favicon -->
...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="../TE Pages/landing.php"><br>
        <h2 class="display-4"><b>Travel Experts</b></h2>
      </a>
      <!-- User -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./examples/profile.php">
              <i class="ni ni-single-02 text-yellow"></i> Agent profile
            </a>
          </li>
